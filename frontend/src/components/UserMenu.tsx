...
const TechSummitBranding = styled.div`
  display: flex;
  flex-direction: column;
...
const TechSummitLabel = styled.div`
  background: #E85D00;
  color: white;
  font-size: 10px;
  font-weight: bold;
  ...
  return (
    <>
     <LogoContainer data-testid="logo-container">
        ...
        <TechSummitBranding>
          <TechSummitLabel>TECH SUMMIT</TechSummitLabel>
          <FY26Label>FY26</FY26Label>
        </TechSummitBranding>
      </LogoContainer>
