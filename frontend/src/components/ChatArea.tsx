...
const ChatArea: React.FC = () => {
  ...
  const exampleQuestions = [
    "Show me the spend of all categories in 2024",
    "How much did we spend on plastic in 2024?",
    "Give me the top 10 suppliers of tea in India based on spend for 2024",
    "Which region is using highest plastic in terms of spend"
  ];
      ...
      <ChatContent data-testid="chat-content">
        <WelcomeContainer visible={!hasMessages} data-testid="welcome-container">
          ...
          <ExampleQuestionsContainer>
            <ExampleQuestionsTitle>Try asking:</ExampleQuestionsTitle>
